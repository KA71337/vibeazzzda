...
const dict={
 az:{
  ...
  heroTitle:'İdman və əyləncə məhsulları Azərbaycanda',heroSub:'VIBE AZ-da aktiv həyat üçün seçilmiş məhsullara baxın.',heroCta:'Məhsullara bax',
  ...
  catalogIntro:'Hərəkət, sağlamlıq və gündəlik həyat üçün diqqətlə seçilmiş məhsullar.',seoIntroTitle:'VIBE AZ nə təklif edir?',seoIntroText:'VIBE AZ Azərbaycanda idman, fitnes, oyun və aktiv həyat üçün seçilmiş məhsulları bir kataloqda təqdim edir. Bakı və ölkədaxili çatdırılma üçün məhsulu seçib sadə sifariş linki yarada bilərsiniz.',favoriteHint:'Bəyəndiyiniz məhsulları ürək işarəsi ilə burada toplayın.',newPrice:'Yeni qiymət',
  ...
  footerClaim:'Müasir seçim. Real keyfiyyət.',location:'VIBE AZ Bakı / VIBE AZ Baku · Azərbaycan',menu:'Menyu',
