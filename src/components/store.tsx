...
const dict={
 az:{
  ...
  heroTitle:'VIBE AZ Bakı — İdman və əyləncə məhsulları Azərbaycanda',heroSub:'VIBE AZ Baku kataloqunda Bakı və Azərbaycanda aktiv həyat üçün seçilmiş məhsullara baxın.',heroCta:'Məhsullara bax',
  ...
  catalogIntro:'Hərəkət, sağlamlıq və gündəlik həyat üçün diqqətlə seçilmiş məhsullar.',seoIntroTitle:'VIBE AZ Bakı nə təklif edir?',seoIntroText:'VIBE AZ Bakı (vibeaz.org) Azərbaycanda idman, fitnes, oyun və aktiv həyat üçün seçilmiş məhsulları bir kataloqda təqdim edir. Bakı və ölkədaxili çatdırılma üçün VIBE AZ Baku kataloqundan məhsulu seçib sadə sifariş linki yarada bilərsiniz.',favoriteHint:'Bəyəndiyiniz məhsulları ürək işarəsi ilə burada toplayın.',newPrice:'Yeni qiymət',
  ...
  footerClaim:'Müasir seçim. Real keyfiyyət.',location:'Bakı, Azərbaycan · VIBE AZ Baku',menu:'Menyu',
 ...
 ru:{
  ...
  heroTitle:'Товары для спорта и отдыха в Азербайджане',heroSub:'Выбирайте товары для активной жизни в VIBE AZ.',heroCta:'Смотреть товары',
  ...
  catalogIntro:'Тщательно отобранные товары для движения, здоровья и повседневной жизни.',seoIntroTitle:'Что предлагает VIBE AZ?',seoIntroText:'VIBE AZ собирает товары для спорта, фитнеса, игр и активной жизни в одном каталоге для Азербайджана. Выберите товар и создайте простую ссылку для заказа с доставкой по Баку и стране.',favoriteHint:'Сохраняйте понравившиеся товары здесь с помощью значка сердца.',newPrice:'Новая цена',
  ...
  footerClaim:'Современный выбор. Настоящее качество.',location:'VIBE AZ Baku · Азербайджан',menu:'Меню',
 ...
 en:{
  ...
  heroTitle:'Sports and leisure products in Azerbaijan',heroSub:'Find products for an active life at VIBE AZ.',heroCta:'Browse products',
  ...
  catalogIntro:'Carefully selected products for movement, wellbeing and everyday life.',seoIntroTitle:'What does VIBE AZ offer?',seoIntroText:'VIBE AZ brings together selected sports, fitness, games and active-lifestyle products for customers in Azerbaijan. Choose a product and create a simple order link for delivery in Baku and across the country.',favoriteHint:'Save products you love here using the heart icon.',newPrice:'New price',
  ...
  footerClaim:'Modern choice. Real quality.',location:'VIBE AZ Baku · Azerbaijan',menu:'Menu',
